...
# Changing the names of the first set of columns
...
# This writing both the percentage cover and frequency dataframes to separate
# csv files
write.csv(survey_total_pc, 'species_pc.csv', row.names = FALSE)
write.csv(survey_total_f, 'species_f.csv', row.names = FALSE)

# For writing the data to an excel sheet
# wb <- createWorkbook()
