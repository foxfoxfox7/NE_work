...
The sites of the LTMN project have been chosen to represent key Biodiversity Action Plan (BAP) broad habitats. Individual plots are recorded as one of the broad habitats when data is collected, and where this categorisation is missing, it is filled using the other available data (such as NVC habitat classification). The broad habitat often represents how the area was when the site was chosen while undergoing transitions.
...
Within each larger NVC group of communities (H, CG, W), there are many differences between the communities (CG2, CG6. For each major NVC group, the individual community split is displayed below over the years.
...
Head of the team - kate.fagan@naturalengland.org.uk
